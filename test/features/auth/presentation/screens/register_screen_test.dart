...
void main() {
  testWidgets('RegisterScreen renderiza campos y botón de registro', (
    WidgetTester tester,
  ) async {
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              const Scaffold(body: Text('Verificar OTP')),
        ),
        GoRoute(
          path: '/login',
  ...
  testWidgets(
    'RegisterScreen layout web muestra panel izquierdo y formulario',
