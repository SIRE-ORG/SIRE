// PI-FEED-01 / PI-FEED-02 / PI-FEED-03 — Prueba de integración de la capa de datos del feed.
//
...
// parsing JSON real, la construcción de modelos y la extracción de owner.name,
// contra una respuesta con la forma exacta del contrato de API.
  ...
  group('FeedRemoteDatasourceRealImpl.getFeed', () {
    test(
      ...
      () async {
        ...
        // La categoría se conserva en mayúsculas (el mapeo a enum de Dart ocurre en el modelo -> entidad).
