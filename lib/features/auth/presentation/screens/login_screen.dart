  ...
  Widget _buildForm(BuildContext context, {required bool isWeb}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Bienvenido a SIRE', style: TextStyle(color: Color(0xFF1E70CD), fontSize: 28, fontWeight: FontWeight.bold)),
          const SizedBox(height: 40),
          const CustomTextField(label: 'Correo', hintText: 'correo@gmail.com', keyboardType: TextInputType.emailAddress),
          const SizedBox(height: 20),
          const CustomTextField(label: 'Contraseña', hintText: 'Tu contraseña', isPassword: true),
          const SizedBox(height: 24),
          SizedBox(
            width: double.infinity,
            height: 50,
            child: CustomButton(text: 'Iniciar sesión', onPressed: () => context.go('/feed')),
          ),
          ...
          Align(
            ...
            child: TextButton(
              ...
              child: const Text('Olvidé mi contraseña', style: TextStyle(color: Color(0xFF1E70CD), fontSize: 14)),
            ),
          ),
          const SizedBox(height: 40),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              child: const Text('Registrarse', style: TextStyle(color: Color(0xFF1E70CD), fontWeight: FontWeight.bold, fontSize: 16)),
            ),
          ),
        ],
      ),
