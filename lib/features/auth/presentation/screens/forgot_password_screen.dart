...
class ForgotPasswordScreen extends StatelessWidget {
  ...
  Widget _buildForm(BuildContext context, {required bool isWeb}) {
    final content = Column(
      ...
      children: [
        if (isWeb) ...[
          const Text('Recuperar contraseña', style: TextStyle(color: Color(0xFF1E70CD), fontSize: 24, fontWeight: FontWeight.bold)),
        ...
        if (isWeb)
          SizedBox(
            ...
            child: CustomButton(
              text: 'Enviar enlace',
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Enlace de recuperación enviado al correo')));
                context.pop();
              },
            ),
          ),
