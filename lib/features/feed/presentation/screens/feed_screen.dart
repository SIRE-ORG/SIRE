...
class FeedScreen extends StatelessWidget {
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildPlaceCard(
                    'Cancha de fútbol sintética', 'Club Deportivo Temuco • Temuco', 'Deporte', '4.7', '(27)'),
                const SizedBox(height: 16),
                _buildPlaceCard(
                    'Consultorio de kinesiología', 'Clínica Santa María • Temuco', 'Salud', '4.8', '(31)'),
                const SizedBox(height: 16),
                _buildPlaceCard('Salón para baile', 'Espacio El Ático • Temuco', 'Eventos', '4.3', '(17)'),
              ],
            ),
          ),
        ],
  ...
  Widget _buildChip(String label, bool isSelected) {
    return Container(
      ...
      child: Text(
        label,
        style: TextStyle(color: isSelected ? Colors.white : Colors.grey.shade600, fontWeight: FontWeight.w500),
      ),
    );
  }

  Widget _buildPlaceCard(String title, String subtitle, String category, String rating, String reviews) {
    return Container(
