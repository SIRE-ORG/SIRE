...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/my-publications', builder: (context, state) => const MyPublicationsScreen()),
      GoRoute(path: '/publication/create', builder: (context, state) => const CreatePublicationScreen()),
      GoRoute(
        path: '/publication/:id/edit',
        builder: (context, state) => EditPublicationScreen(id: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/publication/:id',
        builder: (context, state) => PublicationDetailScreen(id: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/reservation/:id',
      ...
      GoRoute(path: '/received-reservations', builder: (context, state) => const ReceivedReservationsScreen()),
      GoRoute(
